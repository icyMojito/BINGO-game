...
public class OutputView {
    ...
    public static void printRequestForBingoSize() throws IOException {
        bufferedWriter.write("👼🏼 " + Color.MAGENTA_BOLD.fillText("빙고판의 크기") + "를 입력해 주세요!");
        bufferedWriter.newLine();
        bufferedWriter.write("⚠️ 빙고판의 크기는 " + Color.YELLOW_UNDERLINED.fillText("3X3부터 8X8까지")
                                 + " 지정할 수 있으며, " + Color.BLACK_BACKGROUND.fillText("숫자만") + " 입력 가능해요.");
        bufferedWriter.newLine();
